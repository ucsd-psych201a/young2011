...
csv_files <- list.files(path = "~/Coursework/Fall 2024/PSYC 201A/young2011/data/PilotA", pattern = "\\.csv$", full.names = TRUE)

raw_data <- csv_files %>% map_dfr(read_csv)
...
cleaned_data <- raw_data %>% filter(trial_type != "html-keyboard-response")
